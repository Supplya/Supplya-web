...
export class VerifyAccountComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private loaderService: LoaderService, private helperService: HelperService, private route: Router, private authService: AuthService, private notify: ToastyService) {
        ...
        (response) => {
          if (response.status === 'success') {
            ...
            Swal.fire({
              ...
              text: "Please double-check the OTP Verification code, and try again",
              icon: "error",
              showCancelButton: false,
